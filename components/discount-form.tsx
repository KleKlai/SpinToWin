...
export default function DiscountForm({
  ...
  const handleInputChange =
    (setter: React.Dispatch<React.SetStateAction<string>>, field: keyof typeof fieldErrors) =>
  ...
  if (isSubmitted) {
    return (
      <motion.div
        ...
        className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-100 flex items-center justify-center p-4 sm:p-6 md:p-12"
      >
        <div className="w-full max-w-md text-center space-y-6 sm:space-y-8">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl border-4 border-emerald-200">
            <p className="text-gray-600 text-base sm:text-lg mb-4">Your Exclusive Code</p>
            <div className="text-3xl sm:text-4xl md:text-5xl font-black text-emerald-600 tracking-wide mb-4 sm:mb-6 break-all">
              {couponCode}
            </div>
            ...
            <Button
              ...
              size="lg"
              className="w-full py-5 sm:py-6 md:py-7 text-base sm:text-lg md:text-xl bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 transition-all"
            >
              📋 Copy Code
            </Button>
  ...
  return (
    <main
      className={`
        ${compact ? "p-6" : "min-h-screen p-6 sm:p-8 md:p-12"}
    ...
    >
      <motion.div
        ...
        className="w-full max-w-md sm:max-w-lg md:max-w-xl space-y-6 sm:space-y-8"
      >
        <div className="text-center space-y-3 sm:space-y-4">
          <div className="text-5xl sm:text-6xl">🎁</div>
          <h1 className="text-1xl sm:text-2xl md:text-4xl font-bold text-gray-900">
        ...
        {generalError && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="p-4 sm:p-5 rounded-xl sm:rounded-2xl border bg-red-50 border-red-300 text-red-900 flex items-start gap-3"
          >
            <XCircle className="h-5 w-5 sm:h-6 sm:w-6 text-red-600 mt-0.5 flex-shrink-0" />
            <div>
              <p className="font-medium text-sm sm:text-base">{generalError}</p>
            </div>
          </motion.div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl border-2 transition-all text-sm sm:text-base ${
                fieldErrors.email
          ...
          <Button
            ...
            size="lg"
            disabled={isSubmitting}
            className="w-full py-5 sm:py-6 text-base sm:text-lg font-semibold bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 disabled:opacity-60 transition-all shadow-md hover:shadow-lg"
          >
            {isSubmitting ? (
        ...
        <p className="text-center text-xs sm:text-sm text-gray-500 mb-10">
